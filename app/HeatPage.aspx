<%@ Page Title="" Language="C#" MasterPageFile="_App.Master" AutoEventWireup="true" CodeBehind="HeatPage.aspx.cs" Inherits="HybridAppWeb.HeatPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel-heading" role="tab">
            <div class="row">
                ...
                <div class="form-group col-xs-12">
                    <strong>
                        <asp:Label ID="lblHeatCode" runat="server" Font-Bold="True">Heat Code :</asp:Label>
                    </strong>
                    <n0:MOBILEDROPDOWNLIST class="form-control" id="HeatCodeList" runat="server"></n0:MOBILEDROPDOWNLIST>
                </div>
            </div>
            ...
            <div align="center">
                <a class="btn btn-primary waves-effect waves-light" href="#" onclick="checkInput();">Save Heat</a>
            </div>
        </div>
    </div>
    ...
    <script type = "text/javascript">
        ...
        function submit()
        {
			...
			//else
			WriteFormValues("HeatPage.aspx?Type=AddHeat&HerdID=" + herdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);
			var msg = "Heat has been recorded and will be transferred at next synchronisation";
         ...
         function initPage() 
        {
            ...
            FillDynamicList("<%=HeatCodeList.ClientID%>", "HeatCodeList", HerdID, 0);
            ...
            changeSearchPlaceHolder("Record Heat");
             //
         }
                      ...
                      transaction.executeSql(sql, [],
                          function(transaction, results) {
                              ...
                              if (results.rows.length == 1) {
                                  ...
                                  if(row.WithdrawalDate!=''){
                                      alertWithdrawal(row.WithdrawalDate,"Heat");
                                  }
                                     ...
                                     if("<%=Master.HandsFree%>" != "") {
                                            AsyncAndroid.ConvertTextToVoice("");
                                            AsyncAndroid.ConvertTextToVoicePromptResponse("Cant find animal in database. Say Menu, Add, to Add animal or continue");
            ...
            transaction.executeSql(sql, [],
                function (transaction, results) {
                    ...
                    if (results.rows.length == 1) {
                        ...
                        <%--WriteFormValues("HeatPage.aspx?Type=AddHeat&HerdID=" + herdID, document.forms[0], document.forms[0].HidTitle.value);
                        if("<%=Master.IsEID%>" == "1")  {
                            App.message("Heat has been recorded and will be transferred at next synchronisation");
                        }
                        else {
                            App.alert("Result","Heat has been recorded and will be transferred at next synchronisation");
                        }
                        isCommitted = 1;
                        var aniTable = document.getElementById("AnimalListTable");
                        if(aniTable!=null)

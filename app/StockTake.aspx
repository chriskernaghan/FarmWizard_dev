<%@ Page Title="" Language="C#" MasterPageFile="_App.Master" AutoEventWireup="true" CodeBehind="StockTake.aspx.cs" Inherits="HybridAppWeb.StockTake" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type = "text/javascript">
        ...
        function submit()
        {
			...
			//		return false;
			//	}
			//	if (processForm("StockTake") == false) {
			//		return false;
			//	}
			//}
			...
			//else
			WriteFormValues("StockTake.aspx?Type=AddStockTake&HerdID=" + herdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);
			var msg = "StockTake has been recorded and will be transferred at next synchronisation";
        ...
        function initPage()
        {
            ...
            changeSearchPlaceHolder("Record Stocktake");
            //
        }
        ...
        //                          }
        //                          if(row.WithdrawalDate!=''){
        //                              alertWithdrawal(row.WithdrawalDate,"AddStockTake");
        //                          }
                ...
                transaction.executeSql(sql, [],
                    function (transaction, results) {
                        ...
                        if (results.rows.length == 1) {
                            ...
                            WriteFormValues("StockTake.aspx?Type=AddStockTake&HerdID=" + HerdID, document.forms[0], document.forms[0].HidTitle.value);
                            if ("<%=Master.IsEID%>" == "1")
                            {
                                App.message("StockTake has been recorded and will be transferred at next synchronisation");
                            }
                            else {
                                App.alert("Result", "StockTake has been recorded and will be transferred at next synchronisation");
                            }
                            isCommitted = 1;
        ...
        function searchFBBatchAfter(pType)
        {
            ...
            if (pType == 'Birth') {
                if (input_array.length > 1) {
                    App.alert("Error", "Birth page can only record one cow at a time");
                    return false;
                }
            }

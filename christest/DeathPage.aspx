<%@ Page Title="" Language="C#" MasterPageFile="_App.Master" AutoEventWireup="true" CodeBehind="DeathPage.aspx.cs" Inherits="HybridAppWeb.DeathPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab">
            <div class="row">
                ...
                <div class="form-group col-xs-6">
                    <b><asp:Label ID="MannerPlaceDestructionLabel" runat="server" Font-Bold="True">Carcass Disposal :</asp:Label></b>

                    <n0:MOBILEDROPDOWNLIST class="form-control" id="MannerPlaceDestruction" runat="server" DataTextField="TypeName" DataValueField="TypeID"></n0:MOBILEDROPDOWNLIST>
            ...
            <div align="center">
                <br />
                <a href="#" class="btn btn-primary waves-effect waves-light" onclick="checkInput();">Save Death</a>
            </div>
        </div>
    </div>
    ...
    <script type = "text/javascript">
        ...
        function checkInput() {
            ...
            //    document.forms[0].HidTitle.value = "Recorded Death animals";
        ...
        function submit()
        {
			...
			//else
			WriteFormValues("DeathPage.aspx?Type=AddDeath&HerdID=" + herdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);
			var msg = "Death has been recorded and will be transferred at next synchronisation";
        ...
        //                          }
        //                          if(row.WithdrawalDate!=''){
        //                              alertWithdrawal(row.WithdrawalDate,"Death");
        //                          }
...
<%--                            WriteFormValues("DeathPage.aspx?Type=Add" + eventType + "&HerdID=" + HerdID, document.forms[0], document.forms[0].HidTitle.value);
                            if("<%=Master.IsEID%>" == "1")  {

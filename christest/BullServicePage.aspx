<%@ Page Title="" Language="C#" MasterPageFile="_App.Master" AutoEventWireup="true" CodeBehind="BullServicePage.aspx.cs" Inherits="HybridAppWeb.BullServicePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel-heading" role="tab">
            ...
            <div class="row">
                <div class="form-group col-xs-6">
                    ...
                    <n0:MOBILEDROPDOWNLIST class="form-control" id="SireNationalIDList" runat="server"></n0:MOBILEDROPDOWNLIST>
                </div>
                <div class="form-group col-xs-6">
                    <strong>
                        <asp:Label ID="Label20" runat="server">Bull Name :</asp:Label></strong>
                    <n0:MOBILEDROPDOWNLIST class="form-control" id="BullNameList" runat="server"></n0:MOBILEDROPDOWNLIST>
                    <asp:TextBox ID="BullName" runat="server" MaxLength="60"></asp:TextBox>
                </div>
            </div>
            ...
            <div align="center">
                <a href="#" class="btn btn-primary waves-effect waves-light" onclick="checkInput();">Save Bull Service</a>
            </div>
        </div>
    </div>
    ...
    <script type = "text/javascript">
        ...
        function submit()
        {
			...
			//else
			WriteFormValues("BullServicePage.aspx?Type=Add" + pType  + "&HerdID=" + HerdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);
        ...
        function initPage()
        {
                ...
                FillDynamicList("<%=BullNameList.ClientID%>", "NameBullPresent", HerdID, 0);
                FillDynamicList("<%=SireNationalIDList.ClientID%>", "BullBirthEarTag", HerdID, 0);
            ...
            //
                ...
                changeSearchPlaceHolder("Record BullService");
            //
        }
            ...
            //                        }
            //                        if (row.WithdrawalDate != '') {
            //                            alertWithdrawal(row.WithdrawalDate, "BullService");
            //                        }
...
<%--                            WriteFormValues("BullServicePage.aspx?Type=Add" + eventType + "&HerdID=" + HerdID, document.forms[0], document.forms[0].HidTitle.value);
                            if("<%=Master.IsEID%>" == "1")  {
        ...
        function confirmRecord(pId, pValue) {
            if (pValue == false) {
                ...
                if (searchFBBatchAfter("BullService") == false) {
                    return false;
                    //$('#EIDAnimalList').empty();
                    checkInput();
                }

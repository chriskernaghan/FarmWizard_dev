<%@ Page Title="" Language="C#" MasterPageFile="_App.Master" AutoEventWireup="true" CodeBehind="StillBornAbortDestroyedCalfPage.aspx.cs" Inherits="HybridAppWeb.StillBornAbortDestroyedCalfPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">                     
        <div class="panel-heading" role="tab">
            ...
            <div class="row">
                <div class="form-group col-xs-12">
                    <asp:CheckBox ID="AphisStillBornCheckBox" runat="server" Text="Register with APHIS?"></asp:CheckBox>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-xs-12">
        ...
        <div align="center">
            <div class="row">
                <div class="form-group col-xs-12">
                    <a href="#" class="btn btn-primary waves-effect waves-light" onclick="checkInput();">Save Abortion</a>   
                </div>
            </div>       
        </div>
    </div>
    ...
    <script type = "text/javascript">
        ...
        function submit()
        {
			...
			//else
			WriteFormValues("StillBornAbortDestroyedCalfPage.aspx?Type=Add" + pType  + "&HerdID=" + herdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);

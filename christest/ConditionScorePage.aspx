<%@ Page Title="" Language="C#" MasterPageFile="_App.Master" AutoEventWireup="true" CodeBehind="ConditionScorePage.aspx.cs" Inherits="HybridAppWeb.ConditionScorePage" %>
...
<%--                <table align="center">
    ...
    <script type = "text/javascript">
        ...
        function submit()
        {
           ...
           // if (isEID != "1") {
                WriteFormValues("ConditionScorePage.aspx?Type=AddConditionScore&HerdID=" + herdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);
                var msg = "ConditionScore has been recorded and will be transferred at next synchronisation";
            //}
            //else {
            //    WriteFormValues("ConditionScorePage.aspx?Type=AddEIDConditionScore&HerdID=" + herdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);
            //    var msg = "EIDConditionScore has been recorded and will be transferred at next synchronisation";
            //}
        ...
        function initPage() 
        {
            ...
            changeSearchPlaceHolder("Record Condition Score");
            //
        }
        ...
        //                          }
        //                          if(row.WithdrawalDate!=''){
        //                              alertWithdrawal(row.WithdrawalDate,"ConditionScore");
        //                          }
        //                            eidScore(row.NationalID, row.ScoreHistory);
        //                          if (skip == false)
        //                          {
        ...
        function eidScore(pNationalID, pScoreHistory)
        {
            ...
            if (!existRow)
            {
                ...
                App.textInput("Please enter", "Please enter condition score, previously: " + pScoreHistory, "ScoreResults" , pNationalID, true);
            }
        ...
        function ScoreResults(pId, pValue)
        {
            if (pValue == false) {
                ...
                var value = pValue;
                if (isNaN(value)) {
                    App.textInput("Please enter", "Please enter condition score (must be numeric):", "ScoreResults", pId, true)
                }
                else {
                    var tableID = "EIDScoreTable";

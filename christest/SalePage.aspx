<%@ Page Title="" Language="C#" MasterPageFile="_App.Master" AutoEventWireup="true" CodeBehind="SalePage.aspx.cs" Inherits="HybridAppWeb.SalePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel-heading" role="tab">
            <div class="row">
                <div class="form-group col-xs-6">
                    ...
                    <n0:MOBILEDROPDOWNLIST class="form-control" id="DisposedTo" runat="server"></n0:MOBILEDROPDOWNLIST>

                    <div style="margin-top: 5px"></div>
                    <asp:TextBox ID="DisposedToTextBox" class="form-control inpu-sm" runat="server" Width="140px" MaxLength="60"></asp:TextBox>
                </div>
                <div class="form-group col-xs-6">
                    <b>Reason:</b>

                    <n0:MOBILEDROPDOWNLIST class="form-control" id="SoldReasonForCull" runat="server" DataTextField="TypeName" DataValueField="TypeID"></n0:MOBILEDROPDOWNLIST>
    ...
    <script type = "text/javascript">
        ...
        function submit()
        {
			...
			//else
			WriteFormValues("SalePage.aspx?Type=AddSale&HerdID=" + herdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);
			var msg ="Sale has been recorded and will be transferred at next synchronisation";
            ...
            db.transaction(function (transaction) 
            {
                ...
                function (transaction, results) 
                {
                    ...
                    if (results.rows.length == 1) 
                    {
                        ...
                        WriteFormValues("SalePage.aspx?Type=AddSale&HerdID=" + HerdID, document.forms[0], document.forms[0].HidTitle.value);
                        if("<%=Master.IsEID%>" == "1")  {
                            App.message("Sale has been recorded and will be transferred at next synchronisation");
                        }
                        else {
                            App.alert("Result", "Sale has been recorded and will be transferred at next synchronisation");
                        }
                        isCommitted = 1;
        ...
        function initPage() 
        {
            ...
            FillDynamicList("<%=DisposedTo.ClientID%>", "DisposedTo", HerdID, 0);
        ...
        //                          }
        //                          if(row.WithdrawalDate!=''){
        //                              alertWithdrawal(row.WithdrawalDate,"Sale");
        //                          }
        ...
        function processForm() {
            ...
            if (cowList && cowList.selectedIndex == 0) {
                if (document.forms[0].HidAnimalsToAdd.value == "") {
                    App.alert("Result", "No cow selected");
                    return false;
                }
            }

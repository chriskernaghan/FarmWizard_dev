<%@ Page Title="" Language="C#" MasterPageFile="_App.Master" AutoEventWireup="true" CodeBehind="DryOffPage.aspx.cs" Inherits="HybridAppWeb.DryOffPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-6">
                    ...
                    <n0:MOBILEDROPDOWNLIST class="form-control" id="TubeNumber" runat="server" EnableViewState="False">
                        ...
                        <asp:ListItem Value="4" Selected="True">04</asp:ListItem>
    ...
    <script type = "text/javascript">
        ...
        function submit()
        {
			...
			//else
			WriteFormValues("DryOffPage.aspx?Type=AddDryOff&HerdID=" + herdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);
			var msg = "DryOff has been recorded and will be transferred at next synchronisation";
        ...
        function initPage() 
        {
            ...
            FillDynamicList("<%=MedicalTreatment.ClientID%>", "DryMedicineList", HerdID, 0);
        ...
        //                          }
        //                          if(row.WithdrawalDate!=''){
        //                              alertWithdrawal(row.WithdrawalDate,"DryOff");
        //                          }
                   ...
                   transaction.executeSql(sql, [],
                       function (transaction, results) {
                           ...
                           if (results.rows.length == 1) {
                               ...
                               <%--WriteFormValues("DryOffPage.aspx?Type=Add" + eventType + "&HerdID=" + HerdID, document.forms[0], document.forms[0].HidTitle.value);
                               if ("<%=Master.IsEID%>" == "1") {

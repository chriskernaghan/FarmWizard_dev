<%@ Page Title="" Language="C#" MasterPageFile="_App.Master" AutoEventWireup="true" CodeBehind="TakePicturePage.aspx.cs" Inherits="HybridAppWeb.TakePicturePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">                
        <div class="row">
            <div class="form-group col-xs-6">
                <b>Upload Image :</b>
                <input type="file" name="fileToUpload" accept="image/*" id="takePictureField" runat="server" />
                <asp:Label ID="ErrorText" runat="server" Font-Bold="True" ForeColor="Red" Font-Size="Medium"></asp:Label>
            </div>
        </div>
        <br />
        <div align="center">
            <asp:LinkButton class="btn btn-primary waves-effect waves-light"  ID="SavePicture" OnClick="SavePicture_Click" runat="server" Text="Add New Picture"></asp:LinkButton>
             <%--<asp:Button class="btn btn-primary waves-effect waves-light" ID="Button1" OnClick="checkInput();" runat="server" Text="Add New Picture"></asp:Button>--%>
        </div>
    </div>
    ...
    <script type = "text/javascript">
        ...
        function submit()
        {
            ...
            //else
            WriteFormValues("TakePicturePage.aspx?Type=Add" + pType + "&HerdID=" + herdID + "&IsEID=" + isEID, document.forms[0], document.forms[0].HidTitle.value);
            ...
            if("<%=Master.HandsFree%>" != "") {
                ...
                App.alert("Picture Successful", msg);
            }
            else  {
                App.message(msg); 
            }
                ...
                db.transaction(function (transaction) {
                    ...
                    function (transaction, results) {
                        ...
                        if (results.rows.length == 1) {
                            ...
                            document.forms[0].PictureAnimalID.value = row.InternalAnimalID;
                        }
                        else {
                    ...
                    transaction.executeSql(sql, [],
                        function (transaction, results) {
                            ...
                            if (results.rows.length == 1) {
                                ...
                                if (row.WithdrawalDate != '') {
                                    alertWithdrawal(row.WithdrawalDate, "Picture");
                                }
                                document.forms[0].PictureAnimalID.value = row.InternalAnimalID;
